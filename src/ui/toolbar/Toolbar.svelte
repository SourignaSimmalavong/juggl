...
<div class="cy-toolbar-section">
    ...
    <ToolbarButton
        icon={icons.ag_fdgd}
        onClick={condensedClick}
        title="Condensed layout"
    />
    <ToolbarButton
        icon={icons.ag_concentric}
        onClick={concentricClick}
        title="Circle layout"
    />
    <ToolbarButton
        icon={icons.ag_grid}
    ...
    />
    <ToolbarButton
        icon={icons.ag_hierarchy}
        onClick={hierarchyClick}
...
<div class="cy-toolbar-section">
    ...
    <ToolbarButton
        icon={icons.ag_save}
        onClick={saveClick}
        title="Manage workspace graphs"
    />
</div>
<div class="cy-toolbar-section">
    <ToolbarButton
        icon={icons.ag_expand}
        onClick={expandClick}
        disabled={disableOnNoneSelected}
        title="Expand selected nodes (E)"
    />
    <ToolbarButton
        icon={icons.ag_expand}
        onClick={expandInLinksClick}
        disabled={disableOnNoneSelected}
        title="Expand selected nodes (incoming nodes only) (J)"
    />
    <ToolbarButton
        icon={icons.ag_expand}
        onClick={expandOutLinksClick}
        disabled={disableOnNoneSelected}
        title="Expand selected nodes (outgoing nodes only) (.)"
    />
    <ToolbarButton
        icon={icons.ag_collapse}
        onClick={collapseClick}
        disabled={disableOnNoneSelected}
        title="Collapse expanded nodes (C)"
    />
    <ToolbarButton
        icon={icons.ag_hide}
        onClick={hideClick}
        disabled={disableOnNoneSelected}
        title="Hide selected nodes (H)"
    />
</div>
<div class="cy-toolbar-section">
    <ToolbarButton
        icon={icons.ag_select_all}
        onClick={selectAllClick}
        title="Select all nodes (A)"
    />
    <ToolbarButton
        icon={icons.ag_select_inverse}
        onClick={selectInvertClick}
        disabled={disableOnNoneSelected}
        title="Invert selection (I)"
    />
    <ToolbarButton
        icon={icons.ag_select_neighbors}
        onClick={selectNeighborClick}
        disabled={disableOnNoneSelected}
        title="Select neighbors (N)"
    />
</div>
<div class="cy-toolbar-section">
    <ToolbarButton
        icon={icons.ag_lock}
        onClick={lockClick}
        disabled={disableOnAllPinned}
        title="Lock selected nodes in place (P)"
    />
    <ToolbarButton
        icon={icons.ag_unlock}
        onClick={unlockClick}
        disabled={disableOnNonePinned}
        title="Unlock selected nodes in place (U)"
    />
</div>
<!--</div>-->
<br /><label for="ag-filter">Filter: </label><input
    type="text"
    id="ag-filter"
    name="ag-filter"
